...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between pb-4 border-b border-slate-200 dark:border-slate-700">
        <div>
            <h2 class="text-lg font-semibold text-slate-800 dark:text-slate-100">Material Category</h2>
            <p class="text-[12px] text-slate-400 dark:text-slate-500 mt-0.5">Kelola kategori material berdasarkan perilaku</p>
        </div>
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <button wire:click="filterByCard('total')" type="button"
            ...
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs text-slate-400 dark:text-slate-500 mb-1">Total Category</p>
